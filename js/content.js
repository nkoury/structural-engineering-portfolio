  ...
  "pages": {
    ...
    "about": {
      ...
      "personalPursuitsParagraphs": [
        ...
        "The photo set can include a professional portrait, field or site imagery, and a small group of personal images that show who I am beyond the drawings."
      ],
      "engineeringApproachTitle": "Engineering Approach",
      "engineeringApproachItems": [
        {
          "label": "Process",
          "text": "Start with constraints, then make the load path and assumptions visible."
        },
        {
          "label": "Communication",
          "text": "Use clear drawings, model views, and selected calculations to show decisions."
        },
        {
          "label": "Judgment",
          "text": "Balance performance, constructability, cost, and the architectural intent."
        }
      ]
    },
    "contact": {
